...
let Twilio = require('./../vendors/twilio-video');

class VideoConference {
	constructor(token, room, presenterVideoContainer, remoteVideoContainer) {
		this.token = token;
		this.room = room;
		this.presenterVideoContainer = presenterVideoContainer;
